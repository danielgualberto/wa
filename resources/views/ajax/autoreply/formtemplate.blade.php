...
<input type="text" name="footer" class="form-control" id="footer" >
 ...
 <label class="form-label">{{__('system.autoreply_type_reply_image_label')}} <span class="text-sm text-warbubg">{{__('system.optional')}}</span></label>
                   ...
                   <label class="form-label">{{__('system.autoreply_type_reply_template_label')}}<span class="text-sm text-warbubg">{{__('system.autoreply_type_reply_template_label_')}}</span></label><br>
...
<div id="emailHelp" class="form-text">{{__('system.autoreply_type_reply_template_help')}}<br>
    {{__('system.autoreply_type_reply_template_helpCall')}}<br>
    {{__('system.autoreply_type_reply_template_helpLink')}}<br>
    {{__('system.autoreply_type_reply_template_help_')}}
</div>

<label for="template1" class="form-label">Template 1</label>
<input type="text" name="template1" value="{{__('system.autoreply_type_reply_template_value')}}" class="form-control" id="template1" required>
