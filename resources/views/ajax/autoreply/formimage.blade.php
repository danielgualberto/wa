<link rel="stylesheet" href="//maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css">
                   ...
                   <label class="form-label">{{__('system.autoreply_type_reply_image_label')}}</label>
                   <div class="input-group">
                    ...
                    <label for="caption" class="form-label">{{__('system.autoreply_type_reply_image_caption')}}</label>
