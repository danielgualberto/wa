...
class AutoreplyController extends Controller
{
    ...
    public function store(Request $request){
       ...
       if($cek){
        ...
        throw ValidationException::withMessages([
            'keyword' => [__('validation.keyword_already_exists')],
        ]);
       }
        ...
        switch ($type) {
            ...
            case 'image';
                ...
                if(!in_array($ext,$allowext)){
                    return redirect(route('autoreply'))->with('alert',[
                        'type' => 'danger',
                        'msg' => __('validation.autoreply_allowext')
                    ]);
                }
                $reply = [
            ...
            case 'template':
                ...
                try {
                    ...
                    echo __('validation.autoreply_error').__('system.admin_contact');
                }
    ...
    return redirect(route('autoreply'))->with('alert',[
         'type' => 'success',
         'msg' => __('validation.autoreply_added')
     ]);
    ...
    public function makeTemplateButton($templateButton,$no){
        ...
        if (!in_array($type, $allowType)) {
            return redirect(route('autoreply'))->with('alert', [
                'type' => 'danger',
                'msg' => __('validation.autoreply_allowtemplate')
            ]);
        }
